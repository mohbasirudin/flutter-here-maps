...
//     required this.funcClose,
//     Key? key,
//   }) : super(key: key);
//
//   RefreshRouteOptions refreshRouteOptions =
//       RefreshRouteOptions.withCarOptions(CarOptions.withDefaults());
...
//   }) {
//     LocationIndicator _locationIndicator = LocationIndicator();
//     _locationIndicator.locationIndicatorStyle =
//         LocationIndicatorIndicatorStyle.pedestrian;
//     Location _location = Location.withDefaults(geoCoordinates, DateTime.now());
//     _locationIndicator.updateLocation(_location);
//     mapController.addLifecycleListener(_locationIndicator);
//   }
//
